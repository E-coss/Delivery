    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        <div class="my-2 flex sm:flex-row flex-col">
          ...
          <button @click="openModalNew"  class="w-full px-5 py-3 lg:ml-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" >
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                  ...
                  <td class="px-4 py-3 text-sm">
                      <div class="flex items-center space-x-4 text-sm">
                          <button @click="openModal" wire:click="MostrarCategorias({{$categoria->id}},'Edit')" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"  aria-label="Edit" >
      ...
      {{ $categorias->links('components.pagination-tailwind') }}
          ...
          <div class="flex flex-wrap -mx-3 mb-3">
              ...
              placeholder="Nombre de la categoria" type="text" autofocus autocomplete="nombre""/>
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                  ...
                  <div class="relative text-gray-500 focus-within:text-purple-500 dark:focus-within:text-purple-500" >
                      <input  wire:model="descripcion" class="@if($errors->has('descripcion')) border-red-500 dark:border-red-500 @else dark:border-gray-500 @endif block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300  dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-purple form-input"
                      placeholder="Descripción de la categoria" type="text" autofocus autocomplete="descripcion""/>
                      </label>
                        <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none" >  
                          <i class="fas fa-align-right fa-lg"></i>
                        </div>
                ...
                <label class="block mt-4 text-sm">
                  ...
                  <select wire:model="estado" class="@if($errors->has('estado')) border-red-500 dark:border-red-500 @else dark:border-gray-500 @endif block w-full mt-1 text-sm dark:text-gray-300 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                    <option value="Activo" >Activo</option>
                    <option value="Inactivo" >Inactivo</option>
                  </select>
                </label>
          ...
          <button @click="closeModalNew" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg dark:text-gray-400 sm:px-4 sm:py-2 sm:w-auto active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray" >
          Cancelar
          </button>
        ...
        role="dialog"
        id="modal"
        > <form wire:submit.prevent="Update({{$Categoriasid}})">
        <!-- Remove header if you don't want a close icon. Use modal body to place modal tile. -->
        <header class="flex justify-between bg-gray-100 dark:bg-gray-700 px-6 pt-3 -mx-6 -mt-4">
        <p class="mb-2 text-lg font-semibold text-left text-gray-700 dark:text-gray-300" >
        Datos de la categoria
        ...
        <div class="flex flex-wrap -mx-3 mb-3">
            ...
            placeholder="Nombre de la categoria" type="text" autofocus autocomplete="nombre""/>
              ...
              <div class="w-full px-3 mb-6 md:mb-0">
                ...
                <div class="relative text-gray-500 focus-within:text-purple-500 dark:focus-within:text-purple-500" >
                    <input  wire:model="SwCategorias.descripcion" class="@if($errors->has('SwCategorias.descripcion')) border-red-500 dark:border-red-500 @else dark:border-gray-500 @endif block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-500 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-purple form-input"
                    placeholder="Descripción de la categoria" type="text" autofocus autocomplete="descripcion""/>
                    </label>
                      <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none" >  
                        <i class="fas fa-align-right fa-lg"></i>
                 ...
                 @error('SwCategorias.descripcion')
                <p class="mt-1 text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
              </div>
              ...
              <label class="block mt-4 text-sm">
                ...
                <select wire:model="SwCategorias.estado" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-500 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                  <option value="Activo" >Activo</option>
                  <option value="Inactivo" >Inactivo</option>
                </select>
              </label>
