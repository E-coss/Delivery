        ...
        <div class="flex flex-wrap -mx-3 mb-3">
            ...
            placeholder="Nombre de la categoria" type="text" autofocus autocomplete="nombre""/>
              ...
              <label class="block mt-4 text-sm">
                ...
                <select wire:model.defer="SwCategorias.estado" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-500 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                  <option value="Activo" >Activo</option>
                  <option value="Inactivo" >Inactivo</option>
                </select>
              </label>
