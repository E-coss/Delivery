    ...
    <div class="grid w-full overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        <div class="my-2 flex sm:flex-row flex-col">
          ...
          <button wire:click="$toggle('mod')" class="w-full px-5 py-3 lg:ml-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" >
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                  ...
                  <td class="px-4 py-3 text-sm">
                      <div class="flex items-center space-x-4 text-sm">
                          <button wire:click="MostrarCategorias({{$categoria->id}})" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"  aria-label="Edit" >
      ...
      {{ $categorias->links('components.pagination-tailwind') }}
        ...
        <x-jet-dialog-modal wire:model="mod">
          <x-slot name="title"> @if($title != "") {{ $title}} @else Agregar Categoria @endif</x-slot>
          <x-slot name="content">
                ...
                <div class="flex flex-wrap -mx-3 mb-3">
                  ...
                  placeholder="Nombre de la categoria" type="text" autofocus autocomplete="nombre"/>
                    ...
                    <div class="w-full px-3 mb-6 md:mb-0">
                      ...
                      <div class="relative text-gray-500 focus-within:text-purple-500 dark:focus-within:text-purple-500" >
                          <input  wire:model.defer="descripcion" class="@if($errors->has('descripcion')) border-red-500 dark:border-red-500 @else dark:border-gray-500 @endif block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-500 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-purple form-input"
          ...
          @if($title != "Actualizar Categoria")
          <x-jet-danger-button class="ml-2" wire:click="Save()" wire:loading.attr="disabled">
              Crear Categoria
          </x-jet-danger-button>
          @else
          <x-jet-danger-button class="ml-2" wire:click="Update({{$Categoriasid}})" wire:loading.attr="disabled">
