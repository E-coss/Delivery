    ...
    <section class="py-8 dark:bg-gray-800">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg"  src="{{asset('resources/productos/'.$producto->imagen)}}">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="dark:text-gray-300">{{$producto->nombre}}</p>
                    ...
                    <p class="pt-1 text-gray-900 dark:text-gray-300">${{ $producto->precio_venta }}</p>
                </a>
            </div>
            @endforeach
            {{-- 
