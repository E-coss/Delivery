...
<div class="p-4 dark:bg-gray-900">
    ...
    <div class="flex items-center space-y-24 md:space-y-0 flex-col md:flex-row justify evenly">
        <div class=" m-auto shadow-2xl relative">
            <div class="text-center mb-4 absolute -mt-16 right-1/2 transform translate-x-1/2">
                <a href="#" class="block relative">
                    <img alt="profil" src="https://www.tailwind-kit.com/images/person/1.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                </a>
            </div>
        ...
        <div class="m-auto relative shadow-2xl">
            <div class="text-center mb-4 absolute -mt-16 right-1/2 transform translate-x-1/2">
                <a href="#" class="block relative">
                    <img alt="profil" src="https://www.tailwind-kit.com/images/person/1.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                </a>
