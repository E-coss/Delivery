...
<div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="{{ asset('img/login1prueba.jpeg') }}" alt="Office"  />
            ...
            <x-jet-validation-errors class="mb-1" />
              ...
              <div class="block mt-4">
                <label class="flex items-center">
                    <input type="checkbox" class="form-checkbox text-sm font-medium leading-5 text-center text-purple-600 transition-colors duration-150 border-2 border-purple-600 rounded-lg hover:bg-purple-700  " name="remember">
