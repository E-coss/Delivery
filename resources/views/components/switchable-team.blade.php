...
<form method="POST" action="{{ route('current-team.update') }}">
    ...
    <x-dynamic-component class="dark:hover:bg-gray-800 dark:hover:text-gray-200" :component="$component" href="#" onclick="event.preventDefault(); this.closest('form').submit();">
        <div class="flex items-center">
            ...
            <div class="truncate dark:text-gray-300 text-gray-600 font-semibold ">{{ $team->name }}</div>
        </div>
    </x-dynamic-component>
</form>
