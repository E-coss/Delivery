...
<nav id="header" class="w-full z-30 top-0 py-1 dark:bg-gray-800">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                <nav>
                    <ul class="md:flex items-center justify-between text-base text-gray-800 dark:text-gray-300 pt-4 md:pt-0">
                        <li><a class="inline-block no-underline hover:text-gray-500 hover:underline py-2 px-4" href="#">Shop</a></li>
                        <li><a class="inline-block no-underline hover:text-gray-500 hover:underline py-2 px-4" href="#">About</a></li>
                        @auth  
            ...
            <div class="order-1 md:order-2">
                <a class="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 dark:text-gray-300 text-xl " href="{{ url('/') }}">
                    <svg class="fill-current text-gray-800 dark:text-gray-300 mr-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
